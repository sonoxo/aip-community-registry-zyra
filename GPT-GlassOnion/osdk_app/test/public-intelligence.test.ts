...
import {
  canPromoteToCuratedOntology,
  validatePublicIntelligenceRecord,
  type PublicIntelligenceRecord,
} from "../src/public-intelligence.js";
...
const validRecord: PublicIntelligenceRecord = {
  ...
  source: {
    ...
    url: "https://example.gov/public/document-001",
  },
  retrievedAt: "2026-08-27T20:00:00Z",
  confidence: 0.85,
  provenance: {
    sourceType: "public-declassified-archive",
    transformations: ["fetch", "normalize"],
  },
};
...
test("blocks records with missing provenance and invalid confidence", () => {
  const invalid = {
    ...validRecord,
    confidence: 2,
    provenance: { sourceType: "", transformations: [] },
  } as PublicIntelligenceRecord;
